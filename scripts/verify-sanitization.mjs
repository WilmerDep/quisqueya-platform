...
const checks = [
  ...
  },
  {
    ...
    required: ['./components/PlatformShell', './pages/PlatformAccessPage', './pages/PlatformUsersPage'],
    reason: 'the active router must use neutral Quisqueya shell/access/users surfaces and keep inherited lending/demo routes quarantined',
  },
  {
